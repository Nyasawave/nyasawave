    ...
    return (
        <div className="min-h-screen bg-black pt-20 pb-12 px-4">
            <div className="max-w-2xl mx-auto">
                ...
                <p className="text-zinc-400 mb-8">Manage your account and system preferences</p>
                ...
                <div className="bg-zinc-900 rounded-lg p-6 mb-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-zinc-300 mb-2">Admin Name</label>
                            <input
                                type="text"
                                value={settings.name || ''}
